...
public class Exhibit3 extends AppCompatActivity implements Runnable, View.OnClickListener, SeekBar.OnSeekBarChangeListener, GestureDetector.OnGestureListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exhibit3);
    ...
    public void onSwipeLeft() {
        ...
        Intent myIntent = new Intent(Exhibit3.this, Exhibit3b.class);
        Exhibit3.this.startActivity(myIntent);
        finish();
