...
public class Exhibit6b extends AppCompatActivity implements Runnable, View.OnClickListener, SeekBar.OnSeekBarChangeListener, GestureDetector.OnGestureListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exhibit6b);
    ...
    public void onSwipeRight() {
        ...
        Intent myIntent = new Intent(Exhibit6b.this, Exhibit6.class);
        Exhibit6b.this.startActivity(myIntent);
        finish();
